      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>This website lets you register for breakout sessions for the <strong>2019 Justice Summit on Gender</strong> at Bellarmine. However, registrations are currently closed so please view your schedule on the left of the screen. Breakout sessions are built into the Bellarmine schedule for the week of January 28th. Sessions in Blocks 1 and 2 (held on Tuesday) will be presented by guests to the campus, and sessions in Blocks 3 and 4 (held on Wednesday) will be presented by Bellarmine faculty and students.<br /><br />If you have any questions or need help, please contact me by <a href="mailto:marcus.ma20@bcp.org">clicking here</a>.</p>
          </div>
    ...
    <div class="container" id="top">
      ...
      <div class="row">
        ...
        <div class="col-sm-7">
          ...
          <h2>2019 Breakout Sessions</h2>

          <div id="registration-incomplete-alert" class="alert alert-danger" role="alert">
            If you are not registered for all four sessions, please contact me ASAP by <a class="alert-link" href="mailto:marcus.ma20@bcp.org?subject=Justice+Summit+App">clicking here</a>.
          </div>
                ...
                <?php
                  ...
                  for ($block = 1; $block <= 4; $block++) { //Number of blocks
                    ...
                    foreach ($sessions as $session) {
                      ...
                      //for view only mode, all sessions should be shown as not-full (just to avoid confusion, now that the page is not actionable)
                      $full = false;
                      ...
                      echo('<div class="panel panel-default">
                              ...
                              <div id="panel'.$uid.'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="panel'.$uid.'">
                                <div class="panel-body">
								  ...
								  <br>
								  <strong>'.$session["presenterinfo"].'</strong>
